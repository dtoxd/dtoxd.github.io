...
window.onscroll = function() {scrollFunction()};
         function scrollFunction() {
           if (document.documentElement.scrollTop > 15) {
             document.getElementById("logo").style.transform = "scale(0.25) translate(-190%,-165%)";
             document.getElementById("navbar").style.maxHeight = "10%";
             document.getElementById("navbar").style.padding = "10px";
             document.getElementById("navbar").style.backgroundColor = "white";
             document.getElementById("logo").style.transition = "transform 0.45s";
             document.getElementById("navbar").style.transition = "padding 0.5s linear";
             document.getElementById("text").style.vis
           } else {
             ...
             document.getElementById("text").style.transform = "translate(0px,0px)";
